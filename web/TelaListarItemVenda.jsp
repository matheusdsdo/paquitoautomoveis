...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  ...
  <div class="card-deck mb-3 text-center">
          ...
          <div class="card mb-4 shadow-sm">
            ...
            <%
                List<ItemVendaBean> listaItemVenda = (List<ItemVendaBean>)request.getAttribute("listaItemVenda");
                
                Iterator i = listaItemVenda.iterator();
                while(i.hasNext()){
                    //Cria uma instancia do bean cliente
                    ItemVendaBean ItemVenda = (ItemVendaBean) i.next();
                    %>
                    <tr>
                        <td><%=ItemVenda.getCodigo()%></td>
                        <td><%=ItemVenda.getQuatidade()%></td>
