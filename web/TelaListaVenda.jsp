...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  ...
  <div class="card-deck mb-3 text-center">
          ...
          <div class="card mb-4 shadow-sm">
            ...
            <%
                List<VendaBean> listaVenda = (List<VendaBean>)request.getAttribute("listaVendas");
                
                Iterator i = listaVenda.iterator();
                while(i.hasNext()){
                    //Cria uma instancia do bean cliente
                    VendaBean venda = (VendaBean) i.next();
                    %>
                    <tr>
                        <td><%=venda.getCodigo()%></td>
                        <td><%=venda.getDataVenda()%></td>
                        <td><%=venda.getCodigoCli()%></td>
