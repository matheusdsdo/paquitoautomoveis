...
<html>
    ...
    <body>
        ...
        <div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
            <h1 class="display-4">Tela Administrativa</h1>
        </div>

        <div class="card-deck mb-3 text-center">
            <div class="card mb-4 shadow-sm">
                <div class="card-body">
                    <!-- nome, tipo, preco, selecionar imagem, descricao -->
                    <form action="ProdutoServlet?acao=addProduto" method="post" >
                        <td>
                            Nome: 
                        </td>    
                        <td>
                        ...
                        <tr>
                            ...
                            <td><Br><br>
                                Imagem do veículo:
                                <input name="img" type="file" accept="image/jpeg; image/gif; image/bmp; image/png"><br/><br/>
    ...
    <center><footer class="pt-4 my-md-5 pt-md-5 border-top">
            <div class="row">
