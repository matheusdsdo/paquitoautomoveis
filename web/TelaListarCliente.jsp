...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  ...
  <div class="card-deck mb-3 text-center">
          ...
          <div class="card mb-4 shadow-sm">
            ...
            <%
                List<ClienteBean> listaCliente = (List<ClienteBean>)request.getAttribute("listaClientes");
                
                Iterator i = listaCliente.iterator();
                while(i.hasNext()){
                    ...
                    <tr>
                        ...
                        <td><a href="ClienteServlet?acao=excluirCliente&codigo=<%=cliente.getCodigo()%>">Excluir</a></td>
                        <td><a href="ClienteServlet?acao=atualizarCliente&codigo=<%=cliente.getCodigo()%>">Atualizar</a></td>
