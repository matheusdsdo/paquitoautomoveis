...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  ...
  <div class="card-deck mb-3 text-center">
          ...
          <div class="card mb-1 shadow-sm">
              <br>
                    <center><font color="red">Login ou senha incorreta</font></center><br>
              <br>
              <center>
                   <form action="ClienteServlet?acao=verificaLogin" method="POST">
                <td>
                    Login: 
                </td>    
                <td>
              ...
              <br><br><br>
              Você ainda não possui conta? <a href="TelaAdcionaCliente.jsp">Crie sua conta!</a>
          </div>
  </div>
