...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  ...
  <div class="card-deck mb-3 text-center">
        ...
        <%
            List<ClienteBean> linhaSelecionada = (List<ClienteBean>)request.getAttribute("linhaSelecionada");
        ...
        <br>
        <table>
            <form action="ClienteServlet?acao=atlzUsuario" method="POST">
                <td>Nome:</td>
                <tr><td><input type="text" value ="<%= cliente.getNome()%>" name="nome"></tr>
                <td>Email:</td> 
                <tr><td><input type="text" value="<%= cliente.getEmail()%>" name="email"></tr>
                <td>Senha:</td>
                <tr><td><input type="text" value="<%= cliente.getSenha()%>" name="senha"></tr>
                <tr><td></tr>
                <td>Telefone: </td>
                <tr><td><input type="text" value="<%= cliente.getTelefone()%>" name="telefone"></tr>
                <td><input type="hidden" value="<%= cliente.getCodigo()%>" name="codigo"></td><tr><td></td></tr>
