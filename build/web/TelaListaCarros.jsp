...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  ...
  <div class="card-deck mb-3 text-center">
          ...
          <div class="card mb-4 shadow-sm">
            ...
            <%
                List<ProdutoBean> listaProduto = (List<ProdutoBean>)request.getAttribute("listaProduto");
            ...
            %>
                    <tr>
                        ...
                        <td><a href="ProdutoServlet?acao=excluirProduto&codigo=<%=produto.getCodigo()%>">Excluir</a></td>
                        <td><a href="ProdutoServlet?acao=atualizarProduto&codigo=<%=produto.getCodigo()%>">Atualizar</a></td>
