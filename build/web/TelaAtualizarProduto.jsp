...
<div class="pricing-header px-3 py-3 pt-md-5 pb-md-4 mx-auto text-center">
  ...
  <div class="card-deck mb-3 text-center">
        ...
        <%
            List<ProdutoBean> linhaSelecionada = (List<ProdutoBean>)request.getAttribute("linhaSelecionada");
            Iterator i = linhaSelecionada.iterator();
            while(i.hasNext()){
               ProdutoBean produto = (ProdutoBean) i.next();
        %>
        <br>
        <table>
            <form action="ProdutoServlet?acao=atualizarProd" method="POST">
                <td><input type="hidden" value="<%= produto.getCodigo()%>" name="codigo"></td>
                <tr><td>Nome:</td></tr>
                <tr><td><input type="text" value ="<%= produto.getNome()%>" name="nome"></tr>
                <td>Tipo:</td> 
                <tr><td><input type="text" value="<%= produto.getTipo()%>" name="tipo"></tr>
                <td>Descrição:</td>
                <tr><td><input type="text" value="<%= produto.getDescricao()%>" name="descricao"></tr>
                <tr><td></tr>
                <td>Preço: </td>
                <tr><td><input type="text" value="<%= produto.getPreco()%>" name="preco"></tr>
                <td>Quantidade em estoque: </td>
                <tr><td><input type="text" value="<%= produto.getQuantEstoque()%>" name="quantEstoque"></tr>
                <td>Imagem do veículo:</td>
                <td><img src="img/<%=produto.getImagem()%>" width="100" height="70"></td>
                <tr><td><input name="img" type="file" accept="image/jpeg; image/gif; image/bmp; image/png"></tr></td>
            <tr></tr>
            <tr>
